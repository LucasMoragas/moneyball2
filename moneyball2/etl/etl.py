...
def fetch_statistics_for_team_ids(team_ids: list[int], league_id: int, season: int) -> None:
    """
    Fetch statistics for a list of team IDs from the API-Football endpoint for a given league and
    season, and upsert them into the database.
    ...
    for team_id in team_ids:
        ...
        print(f'Upserting statistics for team ID {team_id}: {team_statistics_info}')
        upsert_team_statistics(team_statistics_info)
    print('All selected team statistics have been upserted successfully.')
...
if __name__ == '__main__':
    ...
    season = 2022
    teams = [546, 543]
    fetch_statistics_for_team_ids(teams, league_id, season)
